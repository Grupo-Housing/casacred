...
<main class="overflow-x-hidden overflow-y-auto bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            {{-- Contactadas en el período por asesora --}}
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                @php
                    switch($range) {
                ...
                <h3 class="text-sm font-bold text-gray-700 mb-1 flex items-center gap-2">
                    <span>📞</span> Contactadas — {{ $periodLabel }}
                </h3>
                <p class="text-xs text-gray-400 mb-4">propiedades únicas contactadas en el período</p>
                @if($contactedToday->isEmpty())
                    <div class="flex flex-col items-center justify-center h-24 text-gray-400">
                        <span class="text-2xl mb-1">😴</span>
                        <p class="text-xs">Ninguna contactada en este período</p>
                    </div>
                @else
                    <div class="space-y-3">
                    ...
                    <table class="w-full text-sm">
                        <thead class="sticky top-0 z-10">
                            <tr class="bg-gray-50 border-b border-gray-100">
                                ...
                                <th class="text-left py-2 px-4 text-xs font-semibold text-gray-500 uppercase">Estado actual</th>
                                <th class="text-left py-2 px-4 text-xs font-semibold text-gray-500 uppercase">Comentario(s)</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-50 hover:bg-gray-50 transition">
                                ...
                                <td class="py-3 px-4 align-top">
                                    <span class="text-gray-700 text-xs block" style="max-width:180px">
                                ...
                                <td class="py-3 px-4 align-top hidden sm:table-cell">
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="text-xs text-gray-600 whitespace-nowrap">{{ $item->user->name ?? '—' }}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-4 align-top">
                                    ...
                                    <div class="inline-flex flex-col gap-0.5">
                                        ...
                                        <span class="text-xs text-gray-400 pl-1">{{ $stateConfig['desc'] }}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-4 align-top">
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="flex items-start gap-1.5">
                                            ...
                                            <span class="text-xs text-gray-500">{{ $item->comments['available'] }}</span>
                                        </div>
                                        @endif
                                    </div>
                                </td>
